...
export const metadata = {
  title: "Verdant Horizon - Auth",
  description: "Authentication for Verdant Horizon",
};
      ...
      <head>
        ...
        <style>
          {`
            ...
            .glass-panel {
              background: rgba(51, 54, 50, 0.6);
              backdrop-filter: blur(24px);
            }
            .primary-gradient {
              background: linear-gradient(135deg, #b4cdb8 0%, #1b3022 100%);
            }
          `}
        </style>
      </head>
